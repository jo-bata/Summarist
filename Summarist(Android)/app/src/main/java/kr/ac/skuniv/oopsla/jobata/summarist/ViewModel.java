...
public class ViewModel {
    ...
    private int[] ids_tab_0 = new int[]{R.id.tab_0_1, R.id.tab_0_2, R.id.tab_0_3, R.id.tab_0_4, R.id.tab_0_5, R.id.tab_0_6, R.id.tab_0_7, R.id.tab_0_8, R.id.tab_0_9};
    private int[] ids_tab_1 = new int[]{R.id.tab_1_1, R.id.tab_1_2, R.id.tab_1_3, R.id.tab_1_4, R.id.tab_1_5, R.id.tab_1_6, R.id.tab_1_7, R.id.tab_1_8, R.id.tab_1_9, R.id.tab_1_10, R.id.tab_1_11};
