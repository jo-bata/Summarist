            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    ...
                    case 1 :
                        ...
                        break;
                    case 2 :
                        viewModel.setI(new Intent(activity, WKActivity.class));
                        activity.startActivity(viewModel.getI());
                        activity.finish();
                        break;
                }
        ...
        viewModel.getTabHost().setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                if(viewModel.getTabHost().getCurrentTab() == 0) {
                    new JSONTask(viewModel.getRank_0(), 1).execute("http://192.168.0.6:3000/users1");
                    ...
                    new JSONTask(viewModel.getRank_1(), 10).execute("http://192.168.0.6:3000/users10");
            ...
            if (result <= viewModel.getGetNow()[0]) {
                ...
                switch (viewModel.getTab_state()[0]) {
                    case 0:
                        ...
                        viewModel.getDate_text()[0].setText(viewModel.getDateFormat()[0].format(new Date(viewModel.getGetNow()[1])));
                        new JSONTaskPOST(viewModel.getRank_0(), viewModel.getTab_state()[1] + 1, viewModel.getDateFormat()[1].format(new Date(viewModel.getGetNow()[1])), viewModel.getD_hour()).execute("http://192.168.0.6:3000/post");
                        break;
                    case 1:
                        viewModel.setGetNow(2, result);
                        viewModel.getDate_text()[1].setText(viewModel.getDateFormat()[0].format(new Date(viewModel.getGetNow()[2])));
                        new JSONTaskPOST(viewModel.getRank_1(), viewModel.getTab_state()[2] + 10, viewModel.getDateFormat()[1].format(new Date(viewModel.getGetNow()[2])), viewModel.getD_hour()).execute("http://192.168.0.6:3000/post");
                        break;
                }
            } else
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.tab_1_6:
                    ...
                    new JSONTaskPOST(viewModel.getRank_1(), viewModel.getTab_state()[2] + 10, viewModel.getDateFormat()[1].format(new Date(viewModel.getGetNow()[2])), viewModel.getD_hour()).execute("http://192.168.0.6:3000/post");
                    break;
                case R.id.tab_1_7: viewModel.setTab_state(2, 6);
                    for(int i = 0; i < 11; i ++) {
                        if(i != viewModel.getTab_state()[2])
                            viewModel.getTab_1()[i].setSelected(false);
                        else
